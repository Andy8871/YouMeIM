...
static CURLcode pop3_perform_command(struct connectdata *conn)
{
  ...
  struct POP3 *pop3 = (POP3 *)data->req.protop;
...
static CURLcode pop3_init(struct connectdata *conn)
{
  ...
  struct POP3 *pop3;
	...
	data->req.protop = (POP3*)calloc(sizeof(struct POP3), 1);
  pop3 = (POP3*)data->req.protop;
  if(!pop3)
                             ...
                             bool *dophase_done)
{
  ...
  CURLcode result = CURLE_OK;
  struct POP3 *pop3 = (POP3 *)conn->data->req.protop;
