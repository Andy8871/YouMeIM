...
NSString *kYouMeCommonReachabilityChangedNotification = @"kYouMeCommonNetworkReachabilityChangedNotification";
...
#pragma unused(target, flags)
    ...
    NSCAssert ([(__bridge NSObject *)info isKindOfClass:[YouMeCommonReachability class]],
               @"info was wrong class in ReachabilityCallback");

    YouMeCommonReachability *noteObject = (__bridge YouMeCommonReachability *)info;
    // Post a notification to notify the client that the network reachability changed.
    [[NSNotificationCenter defaultCenter] postNotificationName:kYouMeCommonReachabilityChangedNotification
                                                        object:noteObject];
}
...
@implementation YouMeCommonReachability
{
...
{
    YouMeCommonReachability *returnValue = NULL;
...
+ (instancetype)reachabilityForLocalWiFi
{
    ...
    YouMeCommonReachability *returnValue = [self reachabilityWithAddress:&localWifiAddress];
    if (returnValue != NULL)
    {
