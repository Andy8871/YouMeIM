...
public class YouMeAnimationImageSpan extends DynamicDrawableSpan {

    private Drawable mDrawable;

    public YouMeAnimationImageSpan(){
    	
    }
    
    public YouMeAnimationImageSpan(Drawable d) {
        super();
        mDrawable = d;
        ...
        mHandler.post(new Runnable() {
            public void run() {
                ((YouMeGifDrawable)mDrawable).nextFrame();
                // Set next with a delay depending on the duration for this frame 
                mHandler.postDelayed(this, ((YouMeGifDrawable)mDrawable).getFrameDuration());
            }
        });
    }
    ...
    public Drawable getDrawable() {
        return ((YouMeGifDrawable)mDrawable).getDrawable();
    }
    ...
    public boolean isRunning(){
    	return ((AnimationDrawable)mDrawable).isRunning();
    }
}
